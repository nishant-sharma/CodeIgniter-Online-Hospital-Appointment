    ...
    <body class=""> 
        ...
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <a class="brand" href="<?php echo base_url(); ?>administrator"><span class="first">Admin</span> <span class="second">Arena</span></a>
            </div>
        </div>
        ...
        <div class="row-fluid">
            <div class="dialog">
                <div class="block">
                    ...
                    ?>
                        <form action="<?php echo base_url(); ?>administrator/admin_login.html" method="POST">
                            <label>Username</label>
                            <input type="text" name="admin_email" class="span12">
                            <label>Password</label>
                            <input type="password" name="admin_password" class="span12">
